var $dlgAbout = (function() {
    var $dlg = $(''
              ...
              + '<hr>'
              + '<img class="app-logo" src="../../images/notepad-icon-32.png" alt="JSNotepad">'                                                               + '<div class="info">                                                                                                             
                                                                                                                                                              + '<p>仓库地址：<a href="https://github.com/yujia1997/jsnotepad/" target="_blank">https://github.com/yujia1997/jsnotepad/</a></p>'
                                                                                                                                                              + '</div>'
